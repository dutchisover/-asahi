...
<main class="main page__main">
	...
	<section class="section" data-section-title="Our Service">
		...
		<p class="section__copy">当事務所の分野は「交通事故（被害者側）」「遺産相続／遺言」「労働（残業代請求・解雇・労災）」ですが、<br class="sp-none">それ以外にも幅広い分野を取扱っております。</p>
		...
		<div class="service__content">
			...
			if ($child_pages->have_posts()) {
				...
				echo '<a href="#anc-flow" class="service__sidebar-button">ご相談の流れはこちら</a>';
