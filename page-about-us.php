...
<main class="main page__main">
	...
	<section class="section about__philosophy" data-section-title="Philosophy">
		...
		<p class="about__philosophy-copy section__copy">当事務所はご依頼者様の視点に立った<br class="pc-none">質の高い法的サービスを提供し、<br>「朝日」のようにご依頼者様の未来を照らす存在となることを経営理念としています。</p>
	...
	<section class="section about__feature" data-section-title="Our Features">
		...
		<p class="section__copy is-center">総合法律事務所として、法人案件・個人案件を問わず、<br class="sp-none">幅広い案件を取り扱っております。</p>
