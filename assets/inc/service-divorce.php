        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box">
                ...
                <?php price_table_3col([
                    ...
                    ['訴訟', '44万円<span>(調停から移行する場合は33万円)</span><span>（慰謝料請求、財産分与を<br class="pc-none">訴訟で取扱う場合は<br>各5万5000円を加算）</span>', '44万円'],
                ]); ?>
            ...
            <div class="service__price-box">
                ...
                <?php price_table_5col([
                    ['オプション', '報酬金'],
                    ['親権<span>（１名ごと）</span>', '獲得した場合', '獲得を阻止した場合', '22万円<span>（調査官調査を経た場合は、<br class="pc-none">22万円を加算）</span>', '22万円<span>（調査官調査を経た場合は、<br class="pc-none">22万円を加算）</span>'],
                    ['面会交流<span>（１名ごと）</span>', '達成した場合', '条件向上が実現した場合', '22万円<span>（調査官調査を経た場合は、<br class="pc-none">11万円を加算）</span>', '22万円<span>（調査官調査を経た場合は、<br class="pc-none">11万円を加算）</span>'],
                    ['婚姻費用', '得られた場合', '減額した場合', '得られた額の2年分（現実の受領が2年を超える場合は受領期間分）の11％<span>（最低22万円）</span>', '減額した額の<br class="pc-none">2年分の11％<span>（最低22万円）</span>'],
                    ['養育費', '得られた場合', '減額した場合', '得られた額の<br class="pc-none">5年分の11％<span>（最低22万円）</span>', '減額した額の<br class="pc-none">5年分の11％<span>（最低22万円）</span>'],
            ...
            <div class="service__price-box">
                ...
                <?php price_table_3col([
                    ['解決手段', '着出金', '報酬金'],
                    ['交渉', '22万円', '認容額の22％<span class="is-remark">（最低33万円）</span>'],
                    ['訴訟', '33万円<span class="is-remark">（交渉から移行する場合は22万円）</span>', '認容額の22％<span class="is-remark">（最低44万円）</span>'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。</li>
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['交渉', '22万円'],
                    ['訴訟', '33万円<span class="is-remark">（交渉から移行する場合は22万円）</span>'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。</li>
                </ul>
                ...
                <?php price_table_2col([
                    ...
                    ['300万円を超え<br class="pc-none">3000万円以下', '減額額の11％＋44万円'],
                    ['3000万円を超え<br class="pc-none">3億円以下', '減額額の6.6％＋165万円 '],
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['請求金額', '料金'],
                    ['300万円以下', '請求額の4.4％,<span class="is-remark">（最低11万円）</span>'],
                    ['300万円を超え<br class="pc-none">3000万円以下', '請求額の2.75%<br class="pc-none">＋5万5000円'],
                    ['3000万円を超え<br class="pc-none">3億円以下', '請求額の1.65%<br class="pc-none">＋38万5000円'],
                    ['3億円を超える場合', '請求額の1.1%<br class="pc-none">＋203万5000円'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。</li>
                ...
                <?php price_table_2col([
                    ...
                    ['300万円を超え<br class="pc-none">3000万円以下', '回収金額の5.5%<br class="pc-none">＋9万9000円'],
                    ['3000万円を超え<br class="pc-none">3億円以下', '回収金額の3.3%<br class="pc-none">＋75万9000円'],
                    ['3億円を超える場合', '回収金額の2.2%<br class="pc-none">＋405万9000円'],
                ]); ?>
