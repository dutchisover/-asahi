        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box" id="anc-price-02">
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['協議（交渉）', '22万円'],
                    ['調停・審判', '33万円<span class="is-remark">（協議から移行する場合は22万円）</span>'],
                ]); ?>
            ...
            <div class="service__price-box" id="anc-price-03">
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['交渉', '22万円'],
                    ['調停', '33万円<span class="is-remark">（交渉から移行する場合は22万円）</span>'],
            ...
            <div class="service__price-box" id="anc-price-06">
                ...
                <?php price_table_3col([
                    ['解決手段', '着出金', '報酬金'],
                    ['熟慮期間内の申述', '5万5000円 <span class="is-remark">( 相続人1人につき )</span>', '5万5000円 <span class="is-remark">( 相続人1人につき )</span>'],
                    ['熟慮期間外の申述', '11万円 <span class="is-remark">( 相続人1人につき )</span>', '11万円 <span class="is-remark">( 相続人1人につき )</span>'],
                    ['熟慮期間伸長の申立て', '2万2000円 <span class="is-remark">( 相続人1人につき )</span>', '3万3000円 <span class="is-remark">( 相続人1人につき )</span>'],
                ]); ?>
                <ul class="service__price-list">
