        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ...
                    ['従業員の退職・解雇対応が必要となる場合', '①従業員10名までの場合は、追加11万円<br>②従業員10名を超える場合は、①に加え、<br class="sp-none">追加10名ごとに11万円'],
                    ['債権者数が20名を超える場合', '①債権者数が20名を超え40名までの場合は、追加11万円<br>②債権者数が40名を超える場合は、①に加え、<br class="sp-none">10名ごとに追加6.5万円'],
                ]); ?>
