        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box" id="anc-price-02">
                ...
                <?php price_table_3col([
                    ['解決手段', '着手金', '報酬金'],
                    ['交渉', '0円', '33万円<br class="pc-none">＋認容額の19.8％'],
                    ['労働審判', '22万円', '22万円<br class="pc-none">＋認容額の26.4％'],
                    ['訴訟', '33万円<span>（労働審判から移行する場合は<br class="pc-none">22万円）</span>', '認容額の33％<span class="is-remark">（最低44万円）</span>'],
                ]); ?>
            ...
            <div class="service__price-box" id="anc-price-03">
                ...
                <?php price_table_3col([
                    ['解決手段', '着手金', '報酬金'],
                    ['交渉', '22万円', '33万円<br class="pc-none">＋認容額の19.8％'],
                    ['労働審判', '33万円<span class="is-remark">（交渉から移行する場合は22万円）</span>', '22万円<br class="pc-none">＋認容額の26.4％'],
                    ['訴訟', '44万円<span class="is-remark">（交渉から移行する場合は33万円、労働審判から移行する場合は22万円）</span>', '認容額の33％<span class="is-remark">（最低44万円）</span>'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。</li>
                    <li>「認容額」とは、和解や認容判決等で最終的に認められた相手方の支払額をいいます。</li>
...
',
            ...
            <div class="service__price-box" id="anc-price-04">
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['交渉', '原則0円'],
                    ['労働審判', '33万円<span class="is-remark">（交渉から移行する場合は22万円）'],
                    ['訴訟', '44万円<span class="is-remark">（交渉から移行する場合は33万円、労働審判から移行する場合は22万円）</span>'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。</li>
                ...
                <?php price_table_2col([
                    ...
                    ['300万円を超え<br class="pc-none">3000万円以下', '認容額の19.8％<br class="pc-none">＋6万6000円'],
                    ['3000万円を超える場合', '認容額の16.5％<br class="pc-none">＋105万6000円'],
                ]); ?>
                <ul class="service__price-list">
                    <li>「認容額」とは、和解や認容判決等で最終的に認められた相手方の支払額をいいます。</li>
                </ul>
                ...
                <?php price_table_2col([
                    ['労災保険給付の種類', '料金'],
                    ['障害補償給付<span class="is-remark">（障害等級8～14級に<br class="pc-none">認定された場合）</span>', '給付額の2.2％<span class="is-remark">（最低3万3000円）</span>'],
                    ['障害補償給付<span class="is-remark">（障害等級1～7級に<br class="pc-none">認定された場合）</span>', '55万円'],
                    ['遺族補償給付<span class="is-remark">（年金・一時金）</span>傷病補償年金', '55万円'],
                    ['その他の労災保険給付', '給付額の2.2％<span class="is-remark">（最低3万3000円）</span>'],
                ]); ?>
            </div>
