    ...
    <section class="section" data-section-title="Price of Service" id="anc-price">
        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box" data-fade="100" id="anc-price-01">
                ...
                <div class="service__price-faq">
                    <div class="service__price-faq-image">
                        <img src="<?= get_template_directory_uri(); ?>/assets/image/image_service-example-trafficaccident-02.jpg?01" alt="" class="" width="368" height="230">
                    </div>
                ...
                <?php price_table_2col([
                    ['確定請求額', '追加着手金'],
                    ['125万円を超え<br class="pc-none">300万円以下', '確定請求額の8.8%<br class="pc-none">－110,000円'],
                    ['300万円を超え<br class="pc-none">3000万円以下', '確定請求額の5.5%<br class="pc-none">＋99,000円<br class="pc-none">－110,000円'],
                    ['3000万円を超え<br class="pc-none">3億円以下', '確定請求額の3.3%<br class="pc-none">＋759,000円<br class="pc-none">－110,000円'],
                    ['3億円を超える場合', '確定請求額の2.2%<br class="pc-none">＋4,059,000円<br class="pc-none">－110,000円'],
                ]); ?>
                ...
                <?php price_table_2col([
                    ['回収額', '料金'],
                    ['125万円以下の場合', '220,000円'],
                    ['125万円を超え<br class="pc-none">300万円以下', '回収額の17.6%'],
                    ['300万円を超え<br class="pc-none">3000万円以下', '回収額の11%<br class="pc-none"> + 198,000円'],
                    ['3000万円を超え<br class="pc-none">3億円以下', '回収額の6.6%<br class="pc-none"> + 1,518,000円'],
                    ['3億円を超える場合', '回収額の4.4%<br class="pc-none"> + 8,118,000円'],
                ]); ?>
            </div>
            ...
            <div class="service__price-box" data-fade="100" id="anc-price-02">
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['交渉', '0円<span>（相手方に任意保険会社が<br class="pc-none">ついている場合）</span>'],
                    ['ADR', '220,000円'],
                    ['訴訟', '330,000円<span>（ADRから訴訟に移行する<br class="pc-none">場合は220,000円）</span>'],
                ]); ?>
                ...
                <?php price_table_2col([
                    ['解決手段', '料金'],
                    ['交渉', '回収金額の11％<br class="pc-none">＋220,000円'],
                    ['ADR', '回収金額の11％<br class="pc-none">＋220,000円'],
                    ['訴訟', '回収金額の11％<br class="pc-none">＋220,000円'],
                ]); ?>
