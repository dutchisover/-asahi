    ...
    <section class="section" data-section-title="Price of Service" id="anc-price">
        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box" data-fade="100">
                ...
                <?php price_table_2col([
                    ['内容', '料金'],
                    ['不起訴', '49万5000円<span class="is-remark">（否認事件、裁判員裁判対象事件、複雑な事件の場合は71万5000円）</span>'],
                    ['略式起訴', '38万5000円<span class="is-remark">（否認事件、裁判員裁判対象事件、複雑な事件の場合は60万5000円）</span>'],
                    ['逮捕から4日以内の身柄解放', '33万円'],
                    ['逮捕から5日以降の身柄解放', '22万円'],
                    ['接見禁止の一部解除', '11万円'],
                ]); ?>
                ...
                <?php price_table_2col([
                    ['内容', '料金'],
                    ['保釈が認められた場合', '22万円'],
                    ['執行猶予・罰金刑の場合', '44万円<span class="is-remark">（否認事件の場合は追加11万円）</span><span class="is-remark">（裁判員裁判で執行猶予となった場合は追加22万円）</span>'],
            ...
            <div class="service__price-box" data-fade="100">
                ...
                <?php price_table_2col([
                    ['内容', '料金'],
                    ['家庭裁判所に送致されなかった場合', '49万5000円<span class="is-remark">（否認事件、裁判員裁判対象事件など複雑な事件の場合は71万5000円）</span>'],
                    ['逮捕から4日以内の身柄解放', '33万円'],
                    ['逮捕から5日以降の身柄解放', '22万円'],
                    ['接見禁止の一部解除', '11万円'],
                ]); ?>
                ...
                <?php price_table_2col([
                    ...
                    ['審判不開始又は不処分', '49万5000円<span class="is-remark">（否認事件の場合は追加33万円）<br>（裁判員裁判対象事件の場合は追加22万円）</span>'],
                    ['保護観察', '38.5万円'],
            ...
            <div class="service__price-box" data-fade="100">
                ...
                <?php price_table_2col([
                    ['着手金', '報酬金'],
                    ['13万2000円／3か月<span class="is-remark">（接見1回分の費用を含む）</span>', '0円'],
                ]); ?>
