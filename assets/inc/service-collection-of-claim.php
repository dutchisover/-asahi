    ...
    <section class="section" data-section-title="Price of Service" id="anc-price">
        ...
        <div class="service__price-container">
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['認容額', '料金'],
                    ['300万円以下', '認容額の22％<span class="is-remark">（最低33万円）</span>'],
                    ['300万円を超え<br>3000万円以下', '認容額の13.2%<br class="pc-none"> + 26万4000円'],
                    ['3000万円を超え<br>3億円以下', '認容額の8.8%<br class="pc-none"> + 158万4000円'],
                    ['3億円を超える場合', '認容額の4.4%<br class="pc-none"> + 1478万4000円'],
                ]); ?>
                <ul class="service__price-list">
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['請求金額', '料金'],
                    ['300万円以下', '請求額の11％<span class="is-remark">（最低26万4000円）</span>'],
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['認容額', '料金'],
                    ['500万円以下', '認容額の22％<span class="is-remark">（最低33万円）</span>'],
                    ['500万円を超え<br>5000万円以下', '認容額の16.5%<br class="pc-none"> + 27万5000円'],
                    ['5000万円を超える場合', '認容額の1.1%<br class="pc-none"> + 302万5000円'],
                ]); ?>
                <ul class="service__price-list">
                    <li>「認容額」とは、最終的に和解や認容判決等で認められた相手方の支払額（請求側）または請求を減額した額（請求された側）をいいます。</li>
                </ul>
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['着手金', '報酬金'],
                    ['訴訟の着手金の額の<br class="pc-none">2分の１', '<div class="is-text-left"><span>・審問又は口頭弁論を経たとき、訴訟の報酬金の額の3分の1</span><span>・本案の目的を達したとき、訴訟の報酬金と同額</span></div>'],
                ]); ?>
            </div>
            ...
            <div class="service__price-box">
                ...
                <?php price_table_2col([
                    ['執行額', '料金'],
                    ['300万円以下', '請求額の5.5％<span class="is-remark">（最低11万円）</span>'],
                    ['300万円を超え<br>3000万円以下', '請求額の3.3%<br class="pc-none">＋6万6000円'],
                    ['3000万円を超え<br>3億円以下', '請求額の2.2%<br class="pc-none">＋39万6000円'],
                    ['3億円を超える場合', '請求額の1.1%<br class="pc-none">＋369万6000円'],
                ]); ?>
                <ul class="service__price-list">
                    <li>着手金は月額5万5000円の分割払プランもご用意しております。
                    </li>
                ...
                <?php price_table_2col([
                    ['回収金額', '料金'],
                    ['300万円以下', '回収金額の1.1％<span class="is-remark">（最低22万円）</span>'],
                    ['300万円を超え<br>3000万円以下', '回収金額の6.6%<br class="pc-none">＋13万2000円'],
                    ['3000万円を超え<br>3億円以下', '回収金額の4.4%<br class="pc-none">＋79万2000円'],
                    ['3億円を超える場合', '回収金額の2.2%<br class="pc-none">＋739万2000円'],
                ]); ?>
            </div>
        </div>
